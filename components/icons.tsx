...
export const ChevronRightIcon = ({ className, onClick, style }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement>, style?: React.CSSProperties }) => (
...
export const TrashIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const SettingsIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const XIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const EditIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const FilePlusIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
);
export const Volume2Icon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
);
export const StopIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const RefreshCwIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
    <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10"></polyline><polyline points="1 20 1 14 7 14"></polyline><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"></path></svg>
);
export const CopyIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
...
export const PlayIcon = ({ className, onClick }: { className?: string, onClick?: React.MouseEventHandler<SVGSVGElement> }) => (
